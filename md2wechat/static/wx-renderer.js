var WxRenderer = function (opts) {
  ...
  this.getRenderer = function () {
    ...
    renderer.hr = function(){
      return '<hr style="margin-bottom: 1.2em; border-style: solid;border-width: 1px 0 0;border-color: rgba(0,0,0,0.1);-webkit-transform-origin: 0 0;-webkit-transform: scale(1, 0.5);transform-origin: 0 0;transform: scale(1, 0.5);">';
    }
    return renderer
  }
}